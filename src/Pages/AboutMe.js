...
export default function AboutMe() {
    return (
        ...
        <div className='container p-4' id='aboutme'>
            <div className='row d-flex justify-content-center'>
                <div className='col-6'>
                    <h1 className='text-center'>About Me</h1>
                    <div className='col-4 row-7 offset-7 offset-sm-5 text-center'>
                        <img src="/img/myface.png" class="card-img-top rounded mx-auto d-flex img-fluid img-thumbnail rounded-circle" alt="..." />
                    </div>
                </div>
                <br></br>
                <br></br>
                <div className='col-6 row-6'>
                    <div className="row-4 text-center text-white">
